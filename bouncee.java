...
{void bal()throws Exception
      ...
      char a[][]={{' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','_','_','_',' ',' ',' ',' ',' ',' ',' ',' ',' ',' '},
       ...
       {int x=0;
           ...
           {for(int j=0;j<a[0].length;j++)
            ...
            if(a[x][y]!=a[2][4]&&a[x][y]!=a[2][9]&&a[x][y]!=a[2][12]&&a[x][y]!=a[1][21]&&a[x][y]!=a[1][25]&&a[x][y]!=a[2][27]&&a[x][y]!=a[2][30]&&a[x][y]!=a[2][32]&&a[x][y]!=a[2][34]&&a[x][y]!=a[1][35]&&a[x][y]!=a[1][37]&&a[x][y]!=a[0][40]&&a[x][y]!=a[1][41]&&a[x][y]!=a[2][42]&&a[x][y]!=a[2][45]&&a[x][y]!=a[2][47]&&a[x][y]!=a[2][50]){a[x][y+1]=a[x][y];
                                                                                                                                                                      a[x][y]='_';
                                                                                                                                                                    y++;}
                if(a[x][y]==a[2][4]||a[x][y]==a[2][9]||a[x][y]==a[2][12]||a[x][y]==a[1][21]||a[x][y]==a[1][25]||a[x][y]==a[2][27]||a[x][y]==a[2][30]||a[x][y]==a[2][32]||a[x][y]==a[2][34]||a[x][y]==a[1][35]||a[x][y]==a[1][37]||a[x][y]==a[0][40]||a[x][y]==a[1][41]||a[x][y]==a[2][42]||a[x][y]==a[2][45]||a[x][y]==a[2][47]||a[x][y]==a[2][50]){
    ...
    if(nj==1){bouncee b1=new bouncee();
        System.out.println("\u000c");
        b1.bal();}
